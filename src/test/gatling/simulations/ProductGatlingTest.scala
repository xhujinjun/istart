...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "pno":"SAMPLE_TEXT", "title":"SAMPLE_TEXT", "price":null, "pricedesc":"SAMPLE_TEXT", "preferential":"SAMPLE_TEXT", "costdesc":"SAMPLE_TEXT", "trip":"SAMPLE_TEXT", "start":"SAMPLE_TEXT", "route":"SAMPLE_TEXT", "prodesc":"SAMPLE_TEXT", "rate":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "type":"SAMPLE_TEXT", "startdate":"2020-01-01T00:00:00.000Z", "pics":"SAMPLE_TEXT", "days":"0"}""")).asJSON
            .check(status.is(201))
