...
public class TravelAgencyResource {
     ...
     *
     * @param travelAgencyDTO the travelAgencyDTO to create
     * @return the ResponseEntity with status 201 (Created) and with body the new travelAgencyDTO, or with status 400 (Bad Request) if the travelAgency has already an ID
    ...
    @Timed
    public ResponseEntity<TravelAgencyDTO> createTravelAgency(@RequestBody TravelAgencyDTO travelAgencyDTO) throws URISyntaxException {
        log.debug("REST request to save TravelAgency : {}", travelAgencyDTO);
        if (travelAgencyDTO.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert("travelAgency", "idexists", "A new travelAgency cannot already have an ID")).body(null);
        }
        ...
        return ResponseEntity.created(new URI("/api/travel-agencies/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert("travelAgency", result.getId().toString()))
            .body(result);
    }
     ...
     *
     * @param travelAgencyDTO the travelAgencyDTO to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated travelAgencyDTO,
     * or with status 400 (Bad Request) if the travelAgencyDTO is not valid,
     * or with status 500 (Internal Server Error) if the travelAgencyDTO couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @RequestMapping(value = "/travel-agencies",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<TravelAgencyDTO> updateTravelAgency(@RequestBody TravelAgencyDTO travelAgencyDTO) throws URISyntaxException {
     ...
     * @return the ResponseEntity with status 200 (OK) and the list of travelAgencies in body
    ...
    public ResponseEntity<List<TravelAgencyDTO>> getAllTravelAgencies(Pageable pageable)
        ...
        return new ResponseEntity<>(travelAgencyMapper.travelAgenciesToTravelAgencyDTOs(page.getContent()), headers, HttpStatus.OK);
    }
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the travelAgencyDTO, or with status 404 (Not Found)
     */
    @RequestMapping(value = "/travel-agencies/{id}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<TravelAgencyDTO> getTravelAgency(@PathVariable Long id) {
        ...
        return Optional.ofNullable(travelAgencyDTO)
     ...
     *
     * @param id the id of the travelAgencyDTO to delete
    ...
    /**
     * SEARCH  /_search/travel-agencies?query=:query : search for the travelAgency corresponding
     * to the query.
     *
     * @param query the query of the travelAgency search
     * @return the result of the search
     */
    @RequestMapping(value = "/_search/travel-agencies",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    @Transactional(readOnly = true)
    public ResponseEntity<List<TravelAgencyDTO>> searchTravelAgencies(@RequestParam String query, Pageable pageable)
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/travel-agencies");
        return new ResponseEntity<>(travelAgencyMapper.travelAgenciesToTravelAgencyDTOs(page.getContent()), headers, HttpStatus.OK);
    }
